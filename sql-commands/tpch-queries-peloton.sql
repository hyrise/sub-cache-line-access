...
AND L_DISCOUNT > .06 - 0.01 AND L_DISCOUNT < .06 + 0.01 AND L_QUANTITY < 24;
...
FROM ( SELECT N1.N_NAME AS SUPP_NATION, N2.N_NAME AS CUST_NATION, L_SHIPDATE AS L_YEAR,
 ...
 L_SHIPDATE > '1995-01-01' AND L_SHIPDATE < '1996-12-31' ) AS SHIPPING
...
FROM (SELECT N_NAME AS NATION, SUBSTR(O_ORDERDATE, 0, 4) AS O_YEAR,
